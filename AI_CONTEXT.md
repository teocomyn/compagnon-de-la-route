...
- Le hero de l'accueil utilise une composition éditoriale des quatre photographies fournies par le client dans `public/images/hero` : route nocturne, autocar en montagne, conducteur au poste et bus urbain en mouvement. Sur mobile, la mosaïque précède le titre de marque « Compagnon de la route, plus qu'un métier, une mission ». Deux CTA explicites et les preuves réglementaires factuelles restent présents, sans promesse d'emploi, de financement ou de délai.
