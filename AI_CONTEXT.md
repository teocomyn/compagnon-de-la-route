...
- Le hero de l'accueil utilise la photographie réelle `public/images/journal/conductrice-bus-poste.jpg`, le titre de marque « Compagnon de la route, plus qu'un métier, une mission » et deux CTA explicites. La preuve réglementaire reste factuelle et aucune promesse d'emploi, de financement ou de délai n'est ajoutée.
